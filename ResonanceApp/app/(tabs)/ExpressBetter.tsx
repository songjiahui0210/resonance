...
import { refineExpression, useExpressionRefinement } from '@/app/(tabs)/context';
import {
  TextInput,
  Button,
  Card,
...
export default function ExpressBetterScreen() {
  ...
  // Use 100% height for the expanded view
  ...
  const showModal = useCallback(() => {
    if (bottomSheetRef.current) {
      bottomSheetRef.current.present();
      // Set initial index to 1 to open the sheet at full height
      ...
      <BottomSheetModalProvider>
        <TouchableWithoutFeedback onPress={dismissKeyboard}>
          ...
          >
            ...
            <BottomSheetModal
              ref={bottomSheetRef}
              index={1} // Start at full screen height
